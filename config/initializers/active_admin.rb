ActiveAdmin.setup do |config|
  ...
  config.register_javascript "//maps.google.com/maps/api/js?v=3.13&key=#{ENV.fetch("GOOGLE_API_KEY")}&sensor=false&libraries=geometry,drawing", defer: true, async: true
