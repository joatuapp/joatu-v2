...
ActiveRecord::Schema.define(version: 20150513021218) do
  ...
  add_index "caps_transactions", ["destination_type", "destination_id"], name: "index_caps_transactions_on_destination_type_and_destination_id", using: :btree
  add_index "caps_transactions", ["source_type", "source_id"], name: "index_caps_transactions_on_source_type_and_source_id", using: :btree
  ...
  add_index "offers_and_requests", ["offer_or_request", "pod_id", "created_at"], name: "collection_select_index", using: :btree
  add_index "offers_and_requests", ["type", "pod_id", "created_at"], name: "type_collection_select_index", using: :btree
